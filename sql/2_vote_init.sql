...
(
  ...
  photo_width          smallint comment '照片宽度',
  photo_height         smallint comment '照片高度',
...
(
  ...
  coupon_type          smallint comment '优惠券类型（1折扣；2抵扣；3免费）',
...
(
  session_content      varchar(128) not null comment '令牌主体',
  voter_id             varchar(32) comment '投票人编号',
  create_time          datetime comment '创建时间',
